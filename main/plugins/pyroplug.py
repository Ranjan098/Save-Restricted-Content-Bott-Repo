        ...
        try:
           ...
           # medi =  msg.document or msg.video or msg.audio or None
            ...
            file = await userbot.download_media(
                ...
                progress_args=(
                    client,
                    "**__Unrestricting__: __[your friend](https://t.me/backup98jdj)__**\n ",
                    edit,
                    time.time()
                )
            )  
            ...
            if str(file).split(".")[-1] in ['mkv', 'mp4', 'webm', 'mpe4', 'mpeg', 'ts', 'avi', 'flv', 'org']:
                ...
                caption = f"{msg.caption}\n\n__Unrestricted by **[your friend](https://t.me/backup98jdj)**__" if msg.caption else "__Unrestricted by **[Team SPY](https://t.me/dev_gagan)**__"
                await client.send_video(
                    ...
                    progress_args=(
                        client,
                        '**__Uploading: [your friend](https://t.me/backup98jdj)__**\n ',
                        upm,
                        time.time()
                    )
                )
                ...
                await client.send_document(
                    ...
                    progress_args=(
                        client,
                        '**__Uploading:__**\n**__Bot made by [your friend](https://t.me/backup98jdj)__**',
                        upm,
                        time.time()
                    )
                )
